...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <input type="text" name="userId" id="userId" value="123" placeholder="아이디"> <br/>
    <input type="text" name="email" id="email" value="teran1024@naver.com" placeholder="이메일 주소(@포함)"> <br/><br/>
    <input type="button" id="searchPwd" name="searchId" value="인증번호 받기"><br/><br/>
    ...
    <div id="divRetValue" style="display:none">
        ...
        <input type="button" id="checkValue" name="checkValue" value="확인"><br/><br/>
    </div>
    <div id="divPassword" style="display:none">
        ...
        <input type="button" id="updatePwd" name="updatePwd" value="비밀번호 변경"><br/>
    </div>
<script>
