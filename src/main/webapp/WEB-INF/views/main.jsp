...
<c:forEach var="list" items="${list}" varStatus="status">
	...
	<div class="card">
		<img class="card-img-top" src="${pageContext.request.contextPath}/admin/product/thumbnail.do?no=${list.no}" alt=" " />
		<div class="card-body">
			<h5 class="card-title">${list.title}</h5>
			<p class="card-text">${list.content}</p>
			<p class="card-text">
				<small class="text-muted">
				<a href="${pageContext.request.contextPath}/view/${list.no}" class="btn btn-primary">상세 보기</a>
				</small>
			</p>
<%--			<a href="${pageContext.request.contextPath}/view/${list.no}" class="btn btn-primary">상세 보기</a>--%>
		</div>
